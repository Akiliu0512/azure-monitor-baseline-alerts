...
This page provides the alert settings for AI RAG pattern setup. It contains relative metrics and threshold recommendations for key services involved in a RAG pattern architecture. For a reference architecture design of RAG, see [GPT-RAG](https://github.com/Azure/GPT-RAG).
...
We may update these setting as we continue to work with a breadth of customers.
